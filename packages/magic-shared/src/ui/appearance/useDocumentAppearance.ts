...
/**
 * stamps the appearance onto the document and reports back which one won. whichever
 * view owns the page calls this, since the html class every `dark:` variant keys off
 * is dropped the moment nothing is left declaring it.
 */
